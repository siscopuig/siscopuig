...
<section>
    <div class="container-fluid">
        <div class="row widw py-7">
            <div class="col-12">
                <h2 class="hl2-text mb-7">Service Spectrum</h2>
            </div>
            <div class="col-12">
                <div class="img-box">
...
<section>
    <div class="container-fluid">
        <div class="row-column py-7">
            <div class="col-12 aboutme mb-5">
                <picture>
