...
<div class="container-fluid">
    <section>
        <div class="container-fluid">
            <div class="break-out d-flex align-items-center poster-home poster poster-bg py-7">
    ...
    <section>
        <div class="service-spectrum sp-parent py-3 py-md-5">
            ...
            <div class="flex-wrap py-7">
                ...
                <div class="col-12 mt-3">
                    <div class="sp-img-box">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="390 350 220 180" width="220" height="180"><g><rect x="390" y="350" width="220" height="180" transform="matrix(1,0,0,1,0,0)" fill="none"/><path d=" M 497.797 387.857 Q 524.98 389.571 537.715 405.734 Q 542.1 410.657 545.305 416.756 Q 561.11 418.91 569.388 428.592 Q 579.469 437.94 580 456.836 Q 578.207 475.452 566.858 484.51 Q 557.668 493.851 539.429 494.143 L 514.4 494.143 L 514.4 449.457 L 522.05 449.457 C 524.699 449.457 527.467 449.085 528.225 448.625 L 528.225 448.625 C 528.984 448.166 529.242 447.269 528.8 446.622 L 528.8 446.622 C 528.359 445.975 526.632 443.79 524.945 441.748 L 511.784 425.799 C 506.163 418.986 501.242 413.282 500.8 413.066 L 500.8 413.066 C 500.358 412.849 499.642 412.849 499.2 413.066 L 499.2 413.066 C 498.758 413.282 493.837 418.986 488.216 425.799 L 475.055 441.748 C 473.369 443.79 471.641 445.975 471.2 446.622 L 471.2 446.622 C 470.759 447.269 470.938 448.166 471.6 448.625 L 471.6 448.625 C 472.262 449.085 474.95 449.457 477.599 449.457 L 485.6 449.457 L 485.6 494.143 L 457.47 494.143 Q 437.962 494.222 429.306 483.449 Q 420.175 475.111 420 457.817 Q 421.796 442.061 431.511 434.225 Q 437.609 428.649 446.939 426.306 Q 451.688 410.647 462.695 401.246 Q 474.888 389.194 497.797 387.857 Z " fill="rgb(0,0,0)"/></g></svg>
                    </div>
                    <div class="sp-txt-box">
    ...
    <section class="break-out principles-bg">
        <div class="container-fluid">
            <div class="row principles py-3"> <!-- Adjust padding, margins here -->
    ...
    <!-- End about me -->
    <!-- Let's talk -->
    <section class="break-out talk-bg">
        <div class="row py-7">
            <div class="talk-content col-0 cta">
                <h2 class="hl2-text mb-4 wht">Ready to get started?</h2>
                <p class="text-4 wht mb-5">You know about me, let’s talk about you.</p>
                <!-- <p>let’s talk about you.</p> -->
                <!-- <span class="talk-subline mb-4">You know about me, let’s talk about you.</span> -->
                <!-- <span><a class="mlr-4" href="#">Check out my work</a></span> -->
                <span><a class="mlr-4" href="#">Send me a message</a></span>
            </div>
        </div>
    </section>
    <!-- End Let's talk -->
