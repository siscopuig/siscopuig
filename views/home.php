...
<div class="poster-home linear-gradient">
    <div class="container-fluid">
        <div class="break-out d-flex poster-home poster pt-5 pb-3">
            <div class="d-flex">
...
<div class="widw-container py-5">
    <div class="container-fluid">
        <div class="row py-lg-6 tx-al-ce">
            ...
            <div class="col-12 mb-lg-5">
                <div class="vector-code mb-lg-5"></div>
    ...
    <div class="container-fluid">
        <div class="row py-lg-6">
            <div class="principles-col-1 mb-lg-0 col-lg-3">
                <h2 class="hl2-text wht mb-lg-5">Principles</h2>
            </div>
...
<section>
    <div class="container-fluid">
        <div class="row-column py-lg-6">
            <div class="col-12 aboutme mb-lg-5">
                <picture>
    ...
    <div class="container-fluid">
        <div class="row py-6">
            <div class="talk-content col-0 cta">
                ...
                <p class="text-4 wht">You know about me, let’s talk about you.</p>
