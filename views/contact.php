    ...
    <div class="container-fluid">
        <div class="row center py-lg-6">
            <div class="col-flex-1">
                ...
                <p class="text-2">Lorem ipsum dolor sit amet, timeam epicurei constituto est at, suas mutat duo an, te rebum intellegat mei. In prima liber vis, ea mea inani omittantur consequuntur.</p>
                <p class="text-2">Lorem ipsum dolor sit amet, timeam epicurei constituto est at, suas mutat duo an, te rebum intellegat mei. In prima liber vis, ea mea inani omittantur consequuntur.</p>
            </div>
            <div class="col-flex-1">
                <div class="map">
                ...
                <div class="form-box">
                    ...
                    <form class="form-style"action="http://localhost:63342/siscopuigold/app/config/mail.php" method="post">
                        <div class="form-group" id="name-group">
                            ...
                            <input type="text" class="form-control required" id="name" name="name" aria-required="true" placeholder="Your name" value="">
                        </div>
                        <div class="form-group" id="email-group">
                            <label for="email"></label>
                            <input type="text" class="form-control required email" id="email" name="email" role="banner" placeholder="Your email" aria-required="true" value="">
                        </div>
